...
const validationSchema = Yup.object().shape({
  ...
  offerPrice: Yup.number().required("Required Price is required"),
  paymentTerms: Yup.string().required("Payment Terms is required"),
  liftingDays: Yup.number().required("Lifting Days is required"),
  expiry: Yup.string().required("Expiry is required"),
  address: Yup.string().required("Address is required"),
});
function SellingComponent(props) {
      ...
      >
        ...
        <DialogContent>
          ...
          <ul>
            ...
            <li>Offered Price: {formik.values.offerPrice} USD/MT</li>
          ...
          >
            ...
            >
              ...
              >
                ...
                <Typography variant="subtitle1">Coalshastra</Typography>
              </Box>
            </Box>
          </FormControl>
        </Box>
